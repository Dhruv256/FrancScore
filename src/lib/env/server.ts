...
const serverEnvSchema = z
  .object({
    ...
    NVIDIA_VOCAB_GENERATION_MODEL: nvidiaModelIdSchema.optional(),
    NVIDIA_VOCAB_FALLBACK_MODEL: nvidiaModelIdSchema.optional(),
    NVIDIA_LISTENING_SCRIPT_MODEL: nvidiaModelIdSchema.optional(),
    NVIDIA_LISTENING_FALLBACK_MODEL: nvidiaModelIdSchema.optional(),
    NVIDIA_PDF_PROCESSING_MODEL: nvidiaModelIdSchema.optional(),
    NVIDIA_PDF_FALLBACK_MODEL: nvidiaModelIdSchema.optional(),
    ...
    AI_VOCAB_GENERATION_ENABLED: booleanFlagSchema.default(false),
    DAILY_AI_VOCAB_COUNT: z.coerce.number().int().positive().max(100).default(50),
    LISTENING_TTS_ENABLED: booleanFlagSchema.default(false),
    PDF_PROCESSING_ENABLED: booleanFlagSchema.default(false),
    PDF_BOOK_FEATURE_ENABLED: booleanFlagSchema.default(false),
    PDF_CHUNK_SIZE: z.coerce.number().int().min(1000).max(20000).default(5000),
    PDF_CHUNK_OVERLAP: z.coerce.number().int().min(0).max(5000).default(500),
    PDF_MAX_PAGES_PER_UPLOAD: z.coerce.number().int().positive().max(1000).default(500),
    PDF_CHUNKS_PER_PROCESSING_STEP: z.coerce.number().int().positive().max(10).default(1),
    JOB_POLL_INTERVAL_MS: z.coerce.number().int().min(1000).max(30000).default(2500),
    VOCAB_GENERATION_BATCH_SIZE: z.coerce.number().int().positive().max(50).default(10),
...
function readServerEnvInput() {
  return {
    ...
    NVIDIA_VOCAB_GENERATION_MODEL: process.env.NVIDIA_VOCAB_GENERATION_MODEL,
    NVIDIA_VOCAB_FALLBACK_MODEL: process.env.NVIDIA_VOCAB_FALLBACK_MODEL,
    NVIDIA_LISTENING_SCRIPT_MODEL: process.env.NVIDIA_LISTENING_SCRIPT_MODEL,
    NVIDIA_LISTENING_FALLBACK_MODEL: process.env.NVIDIA_LISTENING_FALLBACK_MODEL,
    NVIDIA_PDF_PROCESSING_MODEL: process.env.NVIDIA_PDF_PROCESSING_MODEL,
    NVIDIA_PDF_FALLBACK_MODEL: process.env.NVIDIA_PDF_FALLBACK_MODEL,
    ...
    AI_VOCAB_GENERATION_ENABLED: process.env.AI_VOCAB_GENERATION_ENABLED,
    DAILY_AI_VOCAB_COUNT: process.env.DAILY_AI_VOCAB_COUNT,
    LISTENING_TTS_ENABLED: process.env.LISTENING_TTS_ENABLED,
    PDF_PROCESSING_ENABLED: process.env.PDF_PROCESSING_ENABLED,
    PDF_BOOK_FEATURE_ENABLED: process.env.PDF_BOOK_FEATURE_ENABLED,
    PDF_CHUNK_SIZE: process.env.PDF_CHUNK_SIZE,
    PDF_CHUNK_OVERLAP: process.env.PDF_CHUNK_OVERLAP,
    PDF_MAX_PAGES_PER_UPLOAD: process.env.PDF_MAX_PAGES_PER_UPLOAD,
    PDF_CHUNKS_PER_PROCESSING_STEP: process.env.PDF_CHUNKS_PER_PROCESSING_STEP,
    JOB_POLL_INTERVAL_MS: process.env.JOB_POLL_INTERVAL_MS,
    VOCAB_GENERATION_BATCH_SIZE: process.env.VOCAB_GENERATION_BATCH_SIZE,
    ...
    SUPABASE_PDF_IMPORTS_BUCKET: process.env.SUPABASE_PDF_IMPORTS_BUCKET,
